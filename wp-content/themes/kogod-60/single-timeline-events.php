...
<section id="content" role="main">
  ...
  <article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
    ...
    <nav class="pagination">
      <?php next_post_link('%link', 'Next Event'); ?>
      <ul>
        <li class="prev"><a href="#">&laquo; Previous<span> Event</span></a></li>
        <li><a href="#">Back to Timeline</a></li>
        <li class="next"><a href="#">Next<span> Event</span> &raquo;</a></li>
      </ul>
    </nav>
